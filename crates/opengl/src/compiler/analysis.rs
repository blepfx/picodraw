...
mod graph {
    ...
    fn transpile_single(
        ...
        let expr = match op {
            ...
            ShaderOp::QuadB => GlslExpr::Swizzle1(emit(GlslExpr::QuadBounds, GlslType::Float4), 0),
            ShaderOp::QuadL => GlslExpr::Swizzle1(emit(GlslExpr::QuadBounds, GlslType::Float4), 1),
            ShaderOp::QuadT => GlslExpr::Swizzle1(emit(GlslExpr::QuadBounds, GlslType::Float4), 2),
            ShaderOp::QuadR => GlslExpr::Swizzle1(emit(GlslExpr::QuadBounds, GlslType::Float4), 3),
