...
macro_rules! generate_bindings {
    ($(fn $name:ident($($argn:ident: $arg:ty),*) $(-> $return:ty)?: [$($binding:ident),*];)*) => {
        pub struct GlBindings {
            $($name: extern "system" fn($($arg,)*) $(-> $return)?,)*
        }
        ...
        impl GlBindings {
            ...
            $(
                pub unsafe fn $name(&self, $($argn: $arg,)*) $(-> $return)? {
                    (self.$name)($($argn,)*)
                }
            )*
        }
...
generate_bindings! {
    ...
    fn bind_buffer(target: GLenum, buffer: GLuint): [glBindBuffer, glBindBufferARB];
    fn buffer_data(target: GLenum, size: GLsizeiptr, data: *const c_void, usage: GLenum): [glBufferData, glBufferDataARB];

    fn map_buffer_range(target: GLenum, offset: GLintptr, length: GLsizeiptr, access: GLbitfield) -> *mut c_void: [glMapBufferRange, glMapBufferRangeEXT];
    fn unmap_buffer(target: GLenum) -> GLboolean: [glUnmapBuffer, glUnmapBufferARB, glUnmapBufferOES];
    fn flush_mapped_buffer_range(target: GLenum, offset: GLintptr, length: GLsizeiptr): [glFlushMappedBufferRange, glFlushMappedBufferRangeAPPLE, glFlushMappedBufferRangeEXT];

    fn gen_textures(n: GLsizei, textures: *mut GLuint): [glGenTextures];
    fn delete_textures(n: GLsizei, textures: *const GLuint): [glDeleteTextures];
    fn bind_texture(target: GLenum, texture: GLuint): [glBindTexture, glBindTextureEXT];
    fn active_texture(texture: GLenum): [glActiveTexture, glActiveTextureARB];
    ...
    fn gen_vertex_arrays(n: GLsizei, arrays: *mut GLuint): [glGenVertexArrays, glGenVertexArraysAPPLE, glGenVertexArraysOES];
    fn delete_vertex_arrays(n: GLsizei, arrays: *const GLuint): [glDeleteVertexArrays, glDeleteVertexArraysAPPLE, glDeleteVertexArraysOES];
    fn bind_vertex_array(array: GLuint): [glBindVertexArray, glBindVertexArrayOES];

    fn create_shader(type_: GLenum) -> GLuint: [glCreateShader, glCreateShaderObjectARB];
    fn delete_shader(shader: GLuint): [glDeleteShader];
    fn shader_source(shader: GLuint, count: GLsizei, string: *const *const GLchar, length: *const GLint): [glShaderSource, glShaderSourceARB];
    fn compile_shader(shader: GLuint): [glCompileShader, glCompileShaderARB];
    fn get_shader_iv(shader: GLuint, pname: GLenum, params: *mut GLint): [glGetShaderiv];
    fn get_shader_info_log(shader: GLuint, buf_size: GLsizei, length: *mut GLsizei, info_log: *mut GLchar): [glGetShaderInfoLog];

    fn create_program() -> GLuint: [glCreateProgram, glCreateProgramObjectARB];
    fn delete_program(program: GLuint): [glDeleteProgram];
    fn attach_shader(program: GLuint, shader: GLuint): [glAttachShader, glAttachObjectARB];
    fn link_program(program: GLuint): [glLinkProgram, glLinkProgramARB];
    fn get_program_iv(program: GLuint, pname: GLenum, params: *mut GLint): [glGetProgramiv];
    fn get_program_info_log(sprogram: GLuint, buf_size: GLsizei, length: *mut GLsizei, info_log: *mut GLchar): [glGetProgramInfoLog];
    fn use_program(program: GLuint): [glUseProgram, glUseProgramObjectARB];

    fn uniform_1i(location: GLint, v0: GLint): [glUniform1i, glUniform1iARB];
    fn uniform_1f(location: GLint, v0: GLfloat): [glUniform1f, glUniform1fARB];
    fn uniform_2f(location: GLint, v0: GLfloat, v1: GLfloat): [glUniform2f, glUniform2fARB];
